  ...
  return {
    ...
    link: function($scope, element, attrs, ngModel) {
      ...
      originalToolbar = [ '<div contentEditable="false" name="inlineToolbar" class="btn-group" role="group" aria-label="..." style="z-index:9999">',
                            ...
                            '<button type="button" ng-click="applyClass(\'ite-subscript\', \'sub\')" class="btn btn-default btn-sm" data-inline-type="ite-subscript" title="subscript"><i class="fa fa-subscript"></i></button>',
                            '<button type="button" ng-click="applyClass(\'ite-superscript\', \'sup\')" class="btn btn-default btn-sm" data-inline-type="ite-superscript" title="superscript"><i class="fa fa-superscript"></i></button>',
                            ...
                            '<div class="color-picker" ng-if="colorPickerActive">',
                              '<span ng-repeat="colorObj in colors">',
                                '<span ng-click="applyColor((\'ite-\' + color))" ng-repeat="(color, hex) in colorObj" class="color" style="background-color:{{color}}" ng-mouseover="setColors(color, hex)"></span>',
                              '</span>',
      ...
      $scope.applyClass = function(cssClass, tagName='span') {
        ...
        classApplier = rangy.createClassApplier(cssClass, {elementTagName: tagName });
