...
let exportDbToJson = async(() => {
    ...
    fs.writeFileSync(path.join(__dirname, 'exports', `result-export-nghiem-thu-de-tai-thuc-vat-${convertFileName(maDeTaiToExport)}.json`), JSON.stringify(result, null, 2))
