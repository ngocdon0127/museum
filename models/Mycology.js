module.exports = function (mongoose) {
	...
	var mycologySchema = mongoose.Schema(schemaPrototype, { typeKey: '$type' });
	var Mycology = mongoose.model("Mycology", mycologySchema);

	global.myCustomVars.models.Mycology = {
		mongooseModel: Mycology
	}
	global.myCustomVars.models['nam'] = global.myCustomVars.models.Mycology;
	return Mycology;
}